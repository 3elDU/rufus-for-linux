...
def formate_usb(device:str, file_system:str, name:str):
    ...
    print("Wipe device")
    os.system("mkfs."+file_system+" -n "+name+" "+device)

def write_iso(iso_file:str, device_to_write:str):
    os.system("umount /mnt/iso")
    os.system("umount /mnt/flash")
    formate_usb(device=device_to_write, file_system="exfat", name="FLASH")
    print("mounting iso...")
